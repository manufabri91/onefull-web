      ...
      <div className="packs">
        ...
        <Carousel className="carrusel">
          <Carousel.Item>
            ...
            />
            <Carousel.Caption>
              <Typography variant="h3">PACK FÚTBOL</Typography>
              <Typography variant="h6">TNT, FOX</Typography>
            </Carousel.Caption>
          </Carousel.Item>
          <Carousel.Item>
            <img
            ...
            />
            <Carousel.Caption>
              <Typography variant="h3">PACK ADULTO</Typography>
              <Typography variant="h6">VENUS, PLAYBOY, BRAZZERS</Typography>
            </Carousel.Caption>
          </Carousel.Item>
          <Carousel.Item>
            <img
            ...
            />
            <Carousel.Caption>
              <Typography variant="h3">PACK MOVIE</Typography>
              <Typography variant="h6">CINECANAL, CINEMAX, OnDemand</Typography>
            </Carousel.Caption>
          </Carousel.Item>
        </Carousel>
      </div>
